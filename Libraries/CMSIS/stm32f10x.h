...
#define  SysTick_CALIB_TENMS                 ((uint32_t)0x00FFFFFF)        /*!< Reload value to use for 10ms Threshold */
...
#define  CEC_CFGR_BTEM            ((uint16_t)0x0004)     /*!<  Bit Threshold Error Mode */
...
#define  CEC_ESR_BTE              ((uint16_t)0x0001)     /*!<  Bit Threshold Error */
...
#define  FSMC_BCR1_WAITCFG                   ((uint32_t)0x00000800)        /*!< Wait Threshold configuration */
...
#define  FSMC_BCR2_WAITCFG                   ((uint32_t)0x00000800)        /*!< Wait Threshold configuration */
...
#define  FSMC_BCR3_WAITCFG                   ((uint32_t)0x00000800)        /*!< Wait Threshold configuration */
...
#define  FSMC_BCR4_WAITCFG                   ((uint32_t)0x00000800)        /*!< Wait Threshold configuration */
