...
void CEC_Init(CEC_InitTypeDef* CEC_InitStruct)
{
  ...
  assert_param(IS_CEC_BIT_Threshold_ERROR_MODE(CEC_InitStruct->CEC_BitThresholdMode)); 
  ...
  /* Configure CEC: Bit Threshold Error and Bit Period Error */
  tmpreg |= (uint16_t)(CEC_InitStruct->CEC_BitThresholdMode | CEC_InitStruct->CEC_BitPeriodMode);
...
/**
  ...
  *     @arg CEC_FLAG_BTE: Bit Threshold Error
