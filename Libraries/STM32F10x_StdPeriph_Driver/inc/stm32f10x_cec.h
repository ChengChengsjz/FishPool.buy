...
typedef struct
{
  uint16_t CEC_BitThresholdMode; /*!< Configures the CEC Bit Threshold Error Mode. 
                               This parameter can be a value of @ref CEC_BitThreshold_Mode */
...
/** @defgroup CEC_BitThreshold_Mode 
  * @{
  */ 
#define CEC_BitThresholdStdMode                    ((uint16_t)0x00) /*!< Bit Threshold error Standard Mode */
#define CEC_BitThresholdErrFreeMode                CEC_CFGR_BTEM   /*!< Bit Threshold error Free Mode */

#define IS_CEC_BIT_Threshold_ERROR_MODE(MODE) (((MODE) == CEC_BitThresholdStdMode) || \
                                            ((MODE) == CEC_BitThresholdErrFreeMode))
/**
  * @}
  */
