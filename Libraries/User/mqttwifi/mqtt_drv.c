...
void mqtt_Content(void)
{
	...
	if(is_new_CMD_rx == 1) //(mqtt_CMDOutPtr != mqtt_CMDInPtr)
	{
		...
		//定时模式
		if(strstr((char *)CMD_rx_buff + 2, "TimeFlag"))
		{
			oled_Clear();
			mode_selection = 1;
		}
		...
		//阈值模式
		if(strstr((char *)CMD_rx_buff + 2, "ThresholdMODE"))
		{
			mode_selection = 2;
			oled_Clear();
		}
		...
		if(strstr((char *)CMD_rx_buff + 2, "Manual"))
		{
			oled_Clear();
			mode_selection = 3;
			System.Switch1 = System.Switch2 = System.Switch3 = System.Switch4 = System.Switch5 = System.Switch6 = System.Switch7 = 0;
		...
		if(strstr((char *)CMD_rx_buff + 2, "Switch5ON"))
		{
			if(manualFlag < 3){
				oled_Clear();
			}
		...
		if(strstr((char *)CMD_rx_buff + 2, "Switch5OFF"))
		{
			if(manualFlag < 3){
				oled_Clear();
			}
		...
		if(strstr((char *)CMD_rx_buff + 2, "Switch6ON"))
		{
			if(manualFlag < 3){
				oled_Clear();
			}
		...
		if(strstr((char *)CMD_rx_buff + 2, "Switch6OFF"))
		{
			if(manualFlag < 3){
				oled_Clear();
			}
		...
		if(strstr((char *)CMD_rx_buff + 2, "Switch7ON"))
		{
			if(manualFlag < 3){
				oled_Clear();
			}
		...
		if(strstr((char *)CMD_rx_buff + 2, "Switch7OFF"))
		{
			if(manualFlag < 3){
				oled_Clear();
			}
		...
		//水温
		if(strstr((char *)CMD_rx_buff + 2, "WtrTempThresholdDown"))
		{
			if(thresholdFlag >= 3){
				oled_Clear();
			}
			thresholdFlag = 0;
			Threshold.WtrTempThreshold -= 1;
		}
		if(strstr((char *)CMD_rx_buff + 2, "WtrTempThresholdAdd"))
		{
			if(thresholdFlag >= 3){
				oled_Clear();
			}
		...
		//水位
		if(strstr((char *)CMD_rx_buff + 2, "WtrLevelThresholdDown"))
		{
			if(thresholdFlag >= 3){
				oled_Clear();
			}
			thresholdFlag =  1;
			Threshold.WtrLevelThreshold -= 1;
		}
		if(strstr((char *)CMD_rx_buff + 2, "WtrLevelThresholdAdd"))
		{
			if(thresholdFlag >= 3){
				oled_Clear();
			}
		...
		//浊度
		if(strstr((char *)CMD_rx_buff + 2, "TurbThersholdDown"))
		{
			if(thresholdFlag < 3){
				oled_Clear();
			}
			thresholdFlag = 3;
			Threshold.TurbThreshold -= 10;
		}
		if(strstr((char *)CMD_rx_buff + 2, "TurbThersholdAdd"))
		{
			if(thresholdFlag < 3){
				oled_Clear();
			}
		...
		//PHMax
		if(strstr((char *)CMD_rx_buff + 2, "PHMaxDown"))
		{
			if(thresholdFlag < 3){
				oled_Clear();
			}
		...
		if(strstr((char *)CMD_rx_buff + 2, "PHMaxAdd"))
		{
			if(thresholdFlag < 3){
				oled_Clear();
			}
		...
		//PHMin
		if(strstr((char *)CMD_rx_buff + 2, "PHMinDown"))
		{
			if(thresholdFlag < 3){
				oled_Clear();
			}
		...
		if(strstr((char *)CMD_rx_buff + 2, "PHMinAdd"))
		{
			if(thresholdFlag < 3){
				oled_Clear();
			}
		...
		//定时模式切换
		if(strstr((char *)CMD_rx_buff + 2, "FeedMode"))
		{
			oled_Clear();
			TimeMode_Selection = 0;
			Threshold.FeedHour -= 1;
		}
		if(strstr((char *)CMD_rx_buff + 2, "OxMode"))
		{
			oled_Clear();
			TimeMode_Selection = 1;
			Threshold.FeedHour += 1;
		}
		
		//时
		if(strstr((char *)CMD_rx_buff + 2, "HourDown"))
		{
			TimeFlag = 1;
			if(TimeMode_Selection == 0){
				Threshold.FeedHour -= 1;
			}
			else Threshold.OxHour -= 1;
		}
		if(strstr((char *)CMD_rx_buff + 2, "HourAdd"))
		{
			TimeFlag = 1;
			if(TimeMode_Selection == 0){
				Threshold.FeedHour += 1;
		...
		//分
		if(strstr((char *)CMD_rx_buff + 2, "MinuteDown"))
		{
			TimeFlag = 2;
			if(TimeMode_Selection == 0){
				Threshold.FeedMinute -= 1;
			}
			else Threshold.OxMinute -= 1;
		}
		if(strstr((char *)CMD_rx_buff + 2, "MinuteAdd"))
		{
			TimeFlag = 2;
			if(TimeMode_Selection == 0){
				Threshold.FeedMinute += 1;
		...
		//执行时间
		if(strstr((char *)CMD_rx_buff + 2, "TimeDown"))
		{
			TimeFlag = 3;
			if(TimeMode_Selection == 0){
				Threshold.FeedTime -= 1;
			}
			else Threshold.OxTime -= 1;
		}
		if(strstr((char *)CMD_rx_buff + 2, "TimeAdd"))
		{
			TimeFlag = 3;
			if(TimeMode_Selection == 0){
				Threshold.FeedTime += 1;
		...
		//定时开关
		if(strstr((char *)CMD_rx_buff + 2, "TimeON"))
		{
			TimeFlag = 4;
			if(TimeMode_Selection == 0){
				FeedTimeFlag = 1;
		...
		if(strstr((char *)CMD_rx_buff + 2, "TimeOFF"))
		{
			TimeFlag = 4;
			if(TimeMode_Selection == 0){
				FeedTimeFlag = 0;
